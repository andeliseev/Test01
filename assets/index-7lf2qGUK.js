...
`}return r=r.replace("%blur%",i),r=r.replace("%size%",n.toString()),r=r.replace("%dimension%",t?"z":"w"),r}function Mh(n,t){const e=Ph(t,n),r=Ah(t);return L.from({vertex:e,fragment:r,name:`blur-${n?"horizontal":"vertical"}-pass-filter`})}var Fh=`
...
fn rand(co: vec2<f32>, seed: f32) -> f32
{
  ...
  return fract(sin(sn) * c + seed);
}`,yp=Object.defineProperty,_p=(n,t,e)=>t in n?yp(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Ba=(n,t,e)=>(_p(n,typeof t!="symbol"?t+"":t,e),e);const bp=class Da extends N{constructor(t){t={...Da.DEFAULT_OPTIONS,...t};const e=t.maxKernelSize??32,r=B.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:vp.replace("${MAX_KERNEL_SIZE}",e.toFixed(1)),entryPoint:"mainFragment"}}),i=L.from({vertex:W,fragment:xp.replace("${MAX_KERNEL_SIZE}",e.toFixed(1)),name:"zoom-blur-filter"});super({gpuProgram:r,glProgram:i,resources:{zoomBlurUniforms:{uStrength:{value:t.strength,type:"f32"},uCenter:{value:t.center,type:"vec2<f32>"},uRadii:{value:new Float32Array(2),type:"vec2<f32>"}}}}),Ba(this,"uniforms"),this.uniforms=this.resources.zoomBlurUniforms.uniforms,Object.assign(this,t)}get strength(){return this.uniforms.uStrength}set strength(t){this.uniforms.uStrength=t}get center(){return this.uniforms.uCenter}set center(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uCenter=t}get centerX(){return this.uniforms.uCenter.x}set centerX(t){this.uniforms.uCenter.x=t}get centerY(){return this.uniforms.uCenter.y}set centerY(t){this.uniforms.uCenter.y=t}get innerRadius(){return this.uniforms.uRadii[0]}set innerRadius(t){this.uniforms.uRadii[0]=t}get radius(){return this.uniforms.uRadii[1]}set radius(t){this.uniforms.uRadii[1]=t<0||t===1/0?-1:t}};Ba(bp,"DEFAULT_OPTIONS",{strength:.1,center:{x:0,y:0},innerRadius:0,radius:-1,maxKernelSize:32});class Sp extends H{constructor(e){super();G(this,"startPos");G(this,"players",[]);G(this,"dragLimit");this.interactiveChildren=!1,this.dragLimit=e,this.x=e}onDragStart(){this.startPos=this.x}OnDragMove(e){let r=Math.round(e+this.startPos);this.x=Math.min(r,this.dragLimit),this.x=Math.max(this.x,-(this.width-D.width))}OnDragEnd(){this.startPos=this.x}velMove(e){let r=Math.round(this.x+e);this.x=Math.min(r,this.dragLimit),this.x=Math.max(this.x,-(this.width-D.width))}update(e){for(let r=0;r<this.players.length;r++)this.players[r].UpdateTextPos()}}const xr=window.Telegram.WebApp;class wp extends H{constructor(e,r){var o,a,l;super();G(this,"sprite");G(this,"text");G(this,"_positionX");G(this,"_startPositionX");this.sprite=St.from(e),this.sprite.anchor.set(.5,1),this.sprite.y=D.height*.68,this.sprite.x=r*60,this.addChild(this.sprite);let i="Player "+r,s=xr==null?void 0:xr.initDataUnsafe;r==0&&(s==null?void 0:s.user)!==void 0&&((s==null?void 0:s.user.username)!==""||(s==null?void 0:s.user.username)!==void 0?i=(o=s==null?void 0:s.user)==null?void 0:o.username:i=((a=s==null?void 0:s.user)==null?void 0:a.first_name)+" "+((l=s==null?void 0:s.user)==null?void 0:l.last_name)),this.text=new ue({text:i,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}}),this.text.anchor.set(.5),this._startPositionX=this.sprite.x,this._positionX=this.sprite.x}get startPositionX(){return this._startPositionX}setStartPositionX(){this._startPositionX=this.sprite.x}get positionX(){return this._positionX}set positionX(e){this._positionX=e,this.sprite.x=e}UpdateTextPos(){this.text.y=this.sprite.getGlobalPosition().y-this.sprite.height-10,this.text.x=this.sprite.getGlobalPosition().x}}const ys=50,Cp=12;class Ap extends H{constructor(){super();G(this,"gameScroll");G(this,"view");G(this,"ui");G(this,"buildings");G(this,"bg");G(this,"ground");G(this,"clouds");G(this,"mountain");G(this,"trees");G(this,"reflectionFilter");G(this,"isDrag",!1);G(this,"dragStartPos");G(this,"delta");G(this,"velX",0);this.gameScroll=new H;const e=new At;e.rect(0,0,D.width,D.height),e.fill("#1F66BA"),this.gameScroll.addChild(e),this.gameScroll.eventMode="static",this.addChild(this.gameScroll),this.createView(ys),this.addChild(this.view),this.buildings=new Sp(ys),this.ui=new H,this.addChild(this.ui);for(let o=0;o<Cp;o++){let a=new wp(o%2?"building01":"building02",o);this.buildings.players.push(a),this.buildings.addChild(a),this.ui.addChild(a.text)}this.view.addChild(this.buildings),this.updatePosition(this.buildings.x),this.reflectionFilter=new Xm({boundary:.71,alpha:[.5,.25],amplitude:[1,2]}),this.view.filters=[this.reflectionFilter];const r=o=>{this.isDrag=!0,this.dragStartPos=o.global.x,this.gameScroll.on("pointermove",i),this.buildings.onDragStart()},i=o=>{let a=this.delta;this.delta=o.data.global.x-this.dragStartPos,this.velX=this.delta-a,this.buildings.OnDragMove(this.delta),this.updatePosition(this.buildings.x)},s=()=>{this.isDrag=!1,this.buildings.OnDragEnd(),this.gameScroll.off("pointermove",i)};this.gameScroll.on("pointerdown",r),this.gameScroll.on("pointerup",s),this.gameScroll.on("pointerupoutside",s)}createView(e){this.view=new H,this.view.interactiveChildren=!1,this.bg=new Ue({texture:O.from("background01"),width:D.width*3,height:D.height}),this.bg.tileScale.y=.81,this.bg.anchor.set(0,.5),this.bg.x=-100,this.bg.y=D.height/2,this.bg.height=D.height,this.view.addChild(this.bg);let r=O.from("clouds01");this.clouds=new Ue({texture:r,width:4e3,height:r.height}),this.clouds.anchor.set(.5),this.clouds.x=Math.round(e*.15)+D.width/2,this.clouds.y=D.height*.5,this.view.addChild(this.clouds);let i=O.from("mountain01");this.mountain=new Ue({texture:i,width:4e3,height:i.height}),this.mountain.anchor.set(.5),this.mountain.x=Math.round(e*.35)+D.width/2,this.mountain.y=D.height*.5,this.view.addChild(this.mountain);let s=O.from("trees01");this.trees=new Ue({texture:s,width:4e3,height:s.height}),this.trees.anchor.set(.5),this.trees.x=Math.round(e*.55)+D.width/2,this.trees.y=D.height*.6,this.view.addChild(this.trees),this.ground=new Ue({texture:O.from("ground01"),width:4e3,height:24}),this.ground.anchor.set(.5,0),this.ground.x=e,this.ground.y=D.height*.68,this.view.addChild(this.ground)}updatePosition(e){this.ground.x=e,this.clouds.x=Math.round(e*.15)+D.width/2,this.mountain.x=Math.round(e*.35)+D.width/2,this.trees.x=Math.round(e*.55)+D.width/2}update(e){this.velX*=.95*e.deltaTime,Math.abs(this.velX)>0&&!this.isDrag&&(this.buildings.velMove(this.velX*e.deltaTime),this.updatePosition(this.buildings.x)),this.reflectionFilter.time+=e.deltaTime*.05,this.buildings.update(e)}}class Tp{constructor(){G(this,"score")}}class vr{static SaveData(t){localStorage.setItem("score",t.score.toString())}static LoadData(t){t.score=parseInt(localStorage.getItem("score"))||0}static ClearData(){localStorage.clear(),window.location.reload()}}class Pp extends H{constructor(){super();G(this,"background");G(this,"scoreText");G(this,"data");G(this,"assetBundles",["testBundle","background","buildings"]);this.data=new Tp,vr.LoadData(this.data)}sizeLog(){const e=Math.max(document.documentElement.clientWidth,window.innerWidth||0),r=Math.max(document.documentElement.clientHeight,window.innerHeight||0),i=new ue({text:e+"x"+r,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});i.anchor.set(.5),i.x=D.width/2,i.y=D.width/2-30,this.addChild(i);const s=new ue({text:D.enlargedWidth+"x"+D.enlargedHeight,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});s.anchor.set(.5),s.x=D.width/2,s.y=D.width/2-20,this.addChild(s);const o=new ue({text:window.Telegram.WebApp.platform,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});o.anchor.set(.5),o.x=D.width/2,o.y=D.width/2-10,this.addChild(o)}constructorWithAssets(){this.background=new Ap,this.addChild(this.background),this.scoreText=new ue({text:"Score: "+this.data.score,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}}),this.scoreText.anchor.set(.5),this.scoreText.x=D.width/2,this.scoreText.y=D.width/2+20,this.addChild(this.scoreText);const e=new Zo(new At().rect(-25,-25,50,25).fill(16777215));e.view.x=D.width/2,e.view.y=D.width/2-20,e.onPress.connect(()=>{this.data.score++,this.scoreText.text="Score: "+this.data.score,vr.SaveData(this.data)}),this.addChild(e.view);const r=new At().roundRect(0,0,20,20,5).fill("black"),i=new ue({text:"❌",style:{fontSize:15}});i.anchor.set(.5),i.x=r.width/2,i.y=r.height/2;const s=new lf;s.addChild(r),s.addChild(i),s.x=D.width-25,s.y=55,s.onPress.connect(()=>{vr.ClearData()}),this.addChild(s)}update(e){this.background.update(e)}}const Re=window.Telegram.WebApp;var _s;((_s=Re.initDataUnsafe)==null?void 0:_s.user)!==void 0&&(Re.ready(),Re.expand(),(Re.platform==="ios"||Re.platform==="android")&&(document.body.style.overflowY="hidden",document.body.style.marginTop="100px",document.body.style.height=window.innerHeight+100+"px",document.body.style.paddingBottom="100px",window.scrollTo(0,100)));(async()=>(await D.init(200,420,1),await D.changeScene(new Pp)))();export{Z as $,ho as A,nt as B,H as C,ot as D,k as E,N as F,B as G,wt as H,Fi as I,St as J,Zl as K,lu as L,Y as M,rt as N,at as O,ct as P,Tu as Q,wn as R,ou as S,Je as T,no as U,Oi as V,Pl as W,Xn as X,j as Y,Rs as Z,z as _,Cr as a,xo as a0,ye as a1,Jc as a2,zo as a3,kh as a4,Bh as a5,be as a6,ut as a7,Wo as a8,Dh as a9,wo as aa,ae as ab,Ih as ac,re as ad,Ct as ae,Ri as af,At as ag,nl as ah,Ao as ai,Tt as b,L as c,Qr as d,mt as e,ts as f,mc as g,xc as h,Kn as i,Lt as j,hn as k,Zr as l,vo as m,vi as n,lo as o,Ws as p,Pt as q,dl as r,O as s,el as t,vc as u,dc as v,lt as w,It as x,Os as y,dt as z};
