...
`,hp=Object.defineProperty,cp=(i,t,e)=>t in i?hp(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,sr=(i,t,e)=>(cp(i,typeof t!="symbol"?t+"":t,e),e);const fp=class Ua extends ${constructor(...t){let e=t[0]??{};(typeof e=="number"||Array.isArray(e)||e instanceof Float32Array)&&(U("6.0.0","ColorOverlayFilter constructor params are now options object. See params: { color, alpha }"),e={color:e},t[1]!==void 0&&(e.alpha=t[1])),e={...Ua.DEFAULT_OPTIONS,...e};const n=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:up,entryPoint:"mainFragment"}}),r=N.from({vertex:H,fragment:lp,name:"color-overlay-filter"});super({gpuProgram:n,glProgram:r,resources:{colorOverlayUniforms:{uColor:{value:new Float32Array(3),type:"vec3<f32>"},uAlpha:{value:e.alpha,type:"f32"}}}}),sr(this,"uniforms"),sr(this,"_color"),this.uniforms=this.resources.colorOverlayUniforms.uniforms,this._color=new j,this.color=e.color??0}get color(){return this._color.value}set color(t){this._color.setValue(t);const[e,n,r]=this._color.toArray();this.uniforms.uColor[0]=e,this.uniforms.uColor[1]=n,this.uniforms.uColor[2]=r}get alpha(){return this.uniforms.uAlpha}set alpha(t){this.uniforms.uAlpha=t}};sr(fp,"DEFAULT_OPTIONS",{color:0,alpha:1});var dp=`in vec2 vTextureCoord;
out vec4 finalColor;
