...
fn rand(co: vec2<f32>, seed: f32) -> f32
{
  ...
  return fract(sin(sn) * c + seed);
}`,bp=Object.defineProperty,Sp=(n,t,e)=>t in n?bp(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Ba=(n,t,e)=>(Sp(n,typeof t!="symbol"?t+"":t,e),e);const wp=class Da extends N{constructor(t){t={...Da.DEFAULT_OPTIONS,...t};const e=t.maxKernelSize??32,r=B.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:_p.replace("${MAX_KERNEL_SIZE}",e.toFixed(1)),entryPoint:"mainFragment"}}),i=L.from({vertex:W,fragment:yp.replace("${MAX_KERNEL_SIZE}",e.toFixed(1)),name:"zoom-blur-filter"});super({gpuProgram:r,glProgram:i,resources:{zoomBlurUniforms:{uStrength:{value:t.strength,type:"f32"},uCenter:{value:t.center,type:"vec2<f32>"},uRadii:{value:new Float32Array(2),type:"vec2<f32>"}}}}),Ba(this,"uniforms"),this.uniforms=this.resources.zoomBlurUniforms.uniforms,Object.assign(this,t)}get strength(){return this.uniforms.uStrength}set strength(t){this.uniforms.uStrength=t}get center(){return this.uniforms.uCenter}set center(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uCenter=t}get centerX(){return this.uniforms.uCenter.x}set centerX(t){this.uniforms.uCenter.x=t}get centerY(){return this.uniforms.uCenter.y}set centerY(t){this.uniforms.uCenter.y=t}get innerRadius(){return this.uniforms.uRadii[0]}set innerRadius(t){this.uniforms.uRadii[0]=t}get radius(){return this.uniforms.uRadii[1]}set radius(t){this.uniforms.uRadii[1]=t<0||t===1/0?-1:t}};Ba(wp,"DEFAULT_OPTIONS",{strength:.1,center:{x:0,y:0},innerRadius:0,radius:-1,maxKernelSize:32});class Cp extends H{constructor(e){super();D(this,"players",[]);this.interactiveChildren=!1}update(e){}updatePosition(e){this.x=Math.round(e)}}const xr=window.Telegram.WebApp;class Ap extends H{constructor(e,r){var o,a,l;super();D(this,"sprite");D(this,"text");D(this,"_positionX");D(this,"_startPositionX");this.sprite=St.from(e),this.sprite.anchor.set(.5,1),this.sprite.y=G.height*.68,this.sprite.x=r*80,this.addChild(this.sprite);let i="Player "+r,s=xr==null?void 0:xr.initDataUnsafe;r==0&&(s==null?void 0:s.user)!==void 0&&((s==null?void 0:s.user.username)!==""||(s==null?void 0:s.user.username)!==void 0?i=(o=s==null?void 0:s.user)==null?void 0:o.username:i=((a=s==null?void 0:s.user)==null?void 0:a.first_name)+" "+((l=s==null?void 0:s.user)==null?void 0:l.last_name)),this.text=new Zt({text:i,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}}),this.text.anchor.set(.5),this.text.y=this.sprite.getGlobalPosition().y-this.sprite.height-10,this.text.x=this.sprite.getGlobalPosition().x,this._startPositionX=this.sprite.x,this._positionX=this.sprite.x}get startPositionX(){return this._startPositionX}setStartPositionX(){this._startPositionX=this.sprite.x}get positionX(){return this._positionX}set positionX(e){this._positionX=e,this.sprite.x=e}}class Tp extends H{constructor(e){super();D(this,"bg");D(this,"ground");D(this,"clouds");D(this,"mountain");D(this,"trees");this.interactiveChildren=!1,this.bg=new Re({texture:U.from("background01"),width:G.width*3,height:G.height}),this.bg.tileScale.y=.81,this.bg.anchor.set(0,.5),this.bg.y=G.height/2,this.bg.height=G.height,this.addChild(this.bg);let r=U.from("clouds01");this.clouds=new Re({texture:r,width:4e3,height:r.height}),this.clouds.anchor.set(.5),this.clouds.x=Math.round(e*.15+G.width/2),this.clouds.y=Math.round(G.height*.5),this.addChild(this.clouds);let i=U.from("mountain01");this.mountain=new Re({texture:i,width:4e3,height:i.height}),this.mountain.anchor.set(.5),this.mountain.x=Math.round(e*.35+G.width/2),this.mountain.y=Math.round(G.height*.5),this.addChild(this.mountain);let s=U.from("trees01");this.trees=new Re({texture:s,width:4e3,height:s.height}),this.trees.anchor.set(.5),this.trees.x=Math.round(e*.55+G.width/2),this.trees.y=Math.round(G.height*.6),this.addChild(this.trees),this.ground=new Re({texture:U.from("ground01"),width:4e3,height:24}),this.ground.anchor.set(.5,0),this.ground.x=e,this.ground.y=Math.round(G.height*.68),this.addChild(this.ground)}updatePosition(e){this.ground.x=e,this.clouds.x=Math.round(e*.15+G.width/2),this.mountain.x=Math.round(e*.35+G.width/2),this.trees.x=Math.round(e*.55+G.width/2)}}const Pp=(n,t,e)=>n*(1-e)+t*e,_s=50,Mp=12;class Fp extends H{constructor(){super();D(this,"scroller");D(this,"view");D(this,"ingameUI");D(this,"background");D(this,"buildings");D(this,"reflectionFilter");D(this,"_isDrag",!1);D(this,"_delta");D(this,"_prevDragPos");D(this,"_currentDragPosition");D(this,"_viewPos");this.scroller=new H;const e=new At().rect(0,0,G.width,G.height).fill("#1F66BA");this.scroller.addChild(e),this.scroller.eventMode="static",this.addChild(this.scroller),this.view=new H,this.addChild(this.view),this.background=new Tp(_s),this.view.addChild(this.background),this.ingameUI=new H,this.buildings=new Cp(_s),this.ingameUI.x=this.buildings.x,this.addChild(this.ingameUI);for(let o=0;o<Mp;o++){let a=new Ap(o%2?"building01":"building02",o);this.buildings.players.push(a),this.buildings.addChild(a),this.ingameUI.addChild(a.text)}this.view.addChild(this.buildings),this.reflectionFilter=new Hm({boundary:.71,alpha:[.5,.25],amplitude:[1,2]}),this.view.filters=[this.reflectionFilter];const r=o=>{this._isDrag=!0,this._currentDragPosition=o.global.x,this._prevDragPos=this._currentDragPosition,this.scroller.on("pointermove",i)},i=o=>{this._currentDragPosition=o.global.x},s=()=>{this._isDrag=!1,this.scroller.off("pointermove",i)};this.scroller.on("pointerdown",r),this.scroller.on("pointerup",s),this.scroller.on("pointerupoutside",s),this._viewPos=G.width/2,this.updatePosition()}get currentViewPos(){return this.buildings.x}updatePosition(){this.buildings.updatePosition(this._viewPos),this.background.updatePosition(this._viewPos),this.ingameUI.x=this.buildings.x}update(e){if(this._isDrag?(this._delta=this._currentDragPosition-this._prevDragPos,this._prevDragPos=this._currentDragPosition):this._delta=Pp(this._delta,0,e.deltaTime*.04),Math.abs(this._delta)>.1){let r=this.buildings.players.length;this._viewPos=Math.min(this._viewPos+this._delta,G.width/2),this._viewPos=Math.max(this._viewPos,-(this.buildings.width-G.width/2-this.buildings.players[r-1].width)),this.updatePosition()}this.reflectionFilter.time+=e.deltaTime*.05}}class zp{constructor(){D(this,"score")}}class vr{static SaveData(t){localStorage.setItem("score",t.score.toString())}static LoadData(t){t.score=parseInt(localStorage.getItem("score"))||0}static ClearData(){localStorage.clear(),window.location.reload()}}class Ip extends H{constructor(){super();D(this,"gameView");D(this,"scoreText");D(this,"data");D(this,"assetBundles",["testBundle","background","buildings"]);this.data=new zp,vr.LoadData(this.data)}sizeLog(){const e=Math.max(document.documentElement.clientWidth,window.innerWidth||0),r=Math.max(document.documentElement.clientHeight,window.innerHeight||0),i=new Zt({text:e+"x"+r,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});i.anchor.set(.5),i.x=G.width/2,i.y=G.width/2-30,this.addChild(i);const s=new Zt({text:G.enlargedWidth+"x"+G.enlargedHeight,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});s.anchor.set(.5),s.x=G.width/2,s.y=G.width/2-20,this.addChild(s);const o=new Zt({text:window.Telegram.WebApp.platform,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});o.anchor.set(.5),o.x=G.width/2,o.y=G.width/2-10,this.addChild(o)}constructorWithAssets(){this.gameView=new Fp,this.addChild(this.gameView),this.scoreText=new Zt({text:"Score: "+this.data.score,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}}),this.scoreText.anchor.set(0,.5),this.scoreText.x=5,this.scoreText.y=95,this.addChild(this.scoreText);let e=new At().roundRect(0,0,50,30,5).fill("black"),r=new Zt({text:`Increase 
score`,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});r.anchor.set(.5),r.x=e.width/2,r.y=e.height/2;const i=new xs;i.addChild(e),i.addChild(r),i.x=5,i.y=55,i.onPress.connect(()=>{open("https://t.me/share/url?url=https://t.me/andeliseevTest01_bot&text=Играй! Строй! ЗАРАБАТЫВАЙ!","_blank"),this.data.score++,this.scoreText.text="Score: "+this.data.score,vr.SaveData(this.data)}),this.addChild(i),e=new At().roundRect(0,0,20,20,5).fill("black"),r=new Zt({text:"❌",style:{fontSize:15}}),r.anchor.set(.5),r.x=e.width/2,r.y=e.height/2;const s=new xs;s.addChild(e),s.addChild(r),s.x=G.width-25,s.y=55,s.onPress.connect(()=>{vr.ClearData()}),this.addChild(s)}update(e){this.gameView.update(e)}}const Yt=window.Telegram.WebApp;let La=420;var bs;if(((bs=Yt.initDataUnsafe)==null?void 0:bs.user)!==void 0){Yt.ready(),Yt.expand();let n=100;Yt.platform==="tdesktop"&&(n=12),(Yt.platform==="ios"||Yt.platform==="android")&&(document.body.style.overflowY="hidden",document.body.style.marginTop=`${n}px`,document.body.style.height=window.innerHeight+n+"px",document.body.style.paddingBottom=`${n}px`,window.scrollTo(0,n)),Yt.platform==="tdesktop"&&(La=400)}(async()=>(await G.init(200,La,1),await G.changeScene(new Ip)))();export{Z as $,fo as A,nt as B,H as C,ot as D,k as E,N as F,B as G,wt as H,Fi as I,St as J,Ql as K,uu as L,Y as M,rt as N,at as O,ct as P,Pu as Q,wn as R,au as S,Je as T,ro as U,Oi as V,Ml as W,Xn as X,j as Y,Es as Z,z as _,Cr as a,vo as a0,_e as a1,th as a2,Io as a3,Bh as a4,Dh as a5,Se as a6,ut as a7,Xo as a8,Lh as a9,Co as aa,ue as ab,Oh as ac,se as ad,Ct as ae,Ri as af,At as ag,rl as ah,To as ai,Tt as b,L as c,Qr as d,mt as e,ts as f,pc as g,vc as h,Kn as i,Lt as j,hn as k,Zr as l,yo as m,vi as n,uo as o,Xs as p,Pt as q,ml as r,U as s,nl as t,yc as u,mc as v,lt as w,It as x,Us as y,dt as z};
