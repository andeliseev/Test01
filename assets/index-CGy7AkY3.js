...
`,bp=Object.defineProperty,Sp=(n,t,e)=>t in n?bp(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Da=(n,t,e)=>(Sp(n,typeof t!="symbol"?t+"":t,e),e);const wp=class Ga extends N{constructor(t){t={...Ga.DEFAULT_OPTIONS,...t};const e=D.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:_p,entryPoint:"mainFragment"}}),r=G.from({vertex:W,fragment:yp,name:"twist-filter"});super({gpuProgram:e,glProgram:r,resources:{twistUniforms:{uTwist:{value:[t.radius??0,t.angle??0],type:"vec2<f32>"},uOffset:{value:t.offset,type:"vec2<f32>"}}},...t}),Da(this,"uniforms"),this.uniforms=this.resources.twistUniforms.uniforms}get radius(){return this.uniforms.uTwist[0]}set radius(t){this.uniforms.uTwist[0]=t}get angle(){return this.uniforms.uTwist[1]}set angle(t){this.uniforms.uTwist[1]=t}get offset(){return this.uniforms.uOffset}set offset(t){this.uniforms.uOffset=t}get offsetX(){return this.offset.x}set offsetX(t){this.offset.x=t}get offsetY(){return this.offset.y}set offsetY(t){this.offset.y=t}};Da(wp,"DEFAULT_OPTIONS",{padding:20,radius:200,angle:4,offset:{x:0,y:0}});var Cp=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
