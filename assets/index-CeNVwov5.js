...
`;let pe=null,Dr=class{constructor(){pe||(pe=URL.createObjectURL(new Blob([ah],{type:"application/javascript"}))),this.worker=new Worker(pe)}};Dr.revokeObjectURL=function(){pe&&(URL.revokeObjectURL(pe),pe=null)};const lh=`(function () {
    'use strict';
...
`,Mf=`struct ExtractBrightnessUniforms {
  uThreshold: f32,
};
...
`,Ff=Object.defineProperty,zf=(n,t,e)=>t in n?Ff(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,ra=(n,t,e)=>(zf(n,typeof t!="symbol"?t+"":t,e),e);const ia=class sa extends N{constructor(t){t={...sa.DEFAULT_OPTIONS,...t};const e=B.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:Mf,entryPoint:"mainFragment"}}),r=L.from({vertex:W,fragment:Pf,name:"extract-brightness-filter"});super({gpuProgram:e,glProgram:r,resources:{extractBrightnessUniforms:{uThreshold:{value:t.threshold,type:"f32"}}}}),ra(this,"uniforms"),this.uniforms=this.resources.extractBrightnessUniforms.uniforms}get threshold(){return this.uniforms.uThreshold}set threshold(t){this.uniforms.uThreshold=t}};ra(ia,"DEFAULT_OPTIONS",{threshold:.5});let If=ia;var Of=Object.defineProperty,Uf=(n,t,e)=>t in n?Of(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,ce=(n,t,e)=>(Uf(n,typeof t!="symbol"?t+"":t,e),e);const Rf=class oa extends N{constructor(t){t={...oa.DEFAULT_OPTIONS,...t};const e=B.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:Tf,entryPoint:"mainFragment"}}),r=L.from({vertex:W,fragment:Af,name:"advanced-bloom-filter"});super({gpuProgram:e,glProgram:r,resources:{advancedBloomUniforms:{uBloomScale:{value:t.bloomScale,type:"f32"},uBrightness:{value:t.brightness,type:"f32"}},uMapTexture:U.WHITE}}),ce(this,"uniforms"),ce(this,"bloomScale",1),ce(this,"brightness",1),ce(this,"_extractFilter"),ce(this,"_blurFilter"),this.uniforms=this.resources.advancedBloomUniforms.uniforms,this._extractFilter=new If({threshold:t.threshold}),this._blurFilter=new na({strength:t.kernels??t.blur,quality:t.kernels?void 0:t.quality}),Object.assign(this,t)}apply(t,e,r,i){const s=dt.getSameSizeTexture(e);this._extractFilter.apply(t,e,s,!0);const o=dt.getSameSizeTexture(e);this._blurFilter.apply(t,s,o,!0),this.uniforms.uBloomScale=this.bloomScale,this.uniforms.uBrightness=this.brightness,this.resources.uMapTexture=o.source,t.applyFilter(this,e,r,i),dt.returnTexture(o),dt.returnTexture(s)}get threshold(){return this._extractFilter.threshold}set threshold(t){this._extractFilter.threshold=t}get kernels(){return this._blurFilter.kernels}set kernels(t){this._blurFilter.kernels=t}get blur(){return this._blurFilter.strength}set blur(t){this._blurFilter.strength=t}get quality(){return this._blurFilter.quality}set quality(t){this._blurFilter.quality=t}get pixelSize(){return this._blurFilter.pixelSize}set pixelSize(t){typeof t=="number"&&(t={x:t,y:t}),Array.isArray(t)&&(t={x:t[0],y:t[1]}),this._blurFilter.pixelSize=t}get pixelSizeX(){return this._blurFilter.pixelSizeX}set pixelSizeX(t){this._blurFilter.pixelSizeX=t}get pixelSizeY(){return this._blurFilter.pixelSizeY}set pixelSizeY(t){this._blurFilter.pixelSizeY=t}};ce(Rf,"DEFAULT_OPTIONS",{threshold:.5,bloomScale:1,brightness:1,blur:8,quality:4,pixelSize:{x:1,y:1}});var Ef=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
fn unmapCoord(coord: vec2<f32> ) -> vec2<f32>
{
    ...
    mappedCoord /= gfu.uInputSize.xy;
    return mappedCoord;
}`,Bf=Object.defineProperty,Df=(n,t,e)=>t in n?Bf(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Lr=(n,t,e)=>(Df(n,typeof t!="symbol"?t+"":t,e),e);const Lf=class aa extends N{constructor(...t){let e=t[0]??{};typeof e=="number"&&(z("6.0.0","AsciiFilter constructor params are now options object. See params: { size, color, replaceColor }"),e={size:e});const r=(e==null?void 0:e.color)&&e.replaceColor!==!1;e={...aa.DEFAULT_OPTIONS,...e};const i=B.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:kf,entryPoint:"mainFragment"}}),s=L.from({vertex:W,fragment:Ef,name:"ascii-filter"});super({gpuProgram:i,glProgram:s,resources:{asciiUniforms:{uSize:{value:e.size,type:"f32"},uColor:{value:new Float32Array(3),type:"vec3<f32>"},uReplaceColor:{value:Number(r),type:"f32"}}}}),Lr(this,"uniforms"),Lr(this,"_color"),this.uniforms=this.resources.asciiUniforms.uniforms,this._color=new j,this.color=e.color??16777215}get size(){return this.uniforms.uSize}set size(t){this.uniforms.uSize=t}get color(){return this._color.value}set color(t){this._color.setValue(t);const[e,r,i]=this._color.toArray();this.uniforms.uColor[0]=e,this.uniforms.uColor[1]=r,this.uniforms.uColor[2]=i}get replaceColor(){return this.uniforms.uReplaceColor>.5}set replaceColor(t){this.uniforms.uReplaceColor=t?1:0}};Lr(Lf,"DEFAULT_OPTIONS",{size:8,color:16777215,replaceColor:!1});var Gf=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,_d=`struct ColorOverlayUniforms {
    uColor: vec3<f32>,
    uAlpha: f32,
};
...
`,Ad=`struct ColorReplaceUniforms {
...
`,um=`// Taken from https://gist.github.com/munrocket/236ed5ba7e409b8bdf1ff6eca5dcdc39
...
`,Cm=`struct MultiColorReplaceUniforms {
...
`,ip=`struct SimpleLightmapUniforms {
  uColor: vec3<f32>,
  uAlpha: f32,
  uDimensions: vec2<f32>,
};
...
}`,cp=Object.defineProperty,hp=(n,t,e)=>t in n?cp(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Hr=(n,t,e)=>(hp(n,typeof t!="symbol"?t+"":t,e),e);const fp=class Ra extends N{constructor(t){t={...Ra.DEFAULT_OPTIONS,...t};const e=B.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:up,entryPoint:"mainFragment"}}),r=L.from({vertex:W,fragment:lp,name:"tilt-shift-axis-filter"});super({gpuProgram:e,glProgram:r,resources:{tiltShiftUniforms:{uBlur:{value:new Float32Array([t.blur??100,t.gradientBlur??600]),type:"vec2<f32>"},uStart:{value:t.start,type:"vec2<f32>"},uEnd:{value:t.end,type:"vec2<f32>"},uDelta:{value:new Float32Array([30,30]),type:"vec2<f32>"},uTexSize:{value:new Float32Array([window.innerWidth,window.innerHeight]),type:"vec2<f32>"}}}}),Hr(this,"uniforms"),Hr(this,"_tiltAxis"),this.uniforms=this.resources.tiltShiftUniforms.uniforms,this._tiltAxis=t.axis,this.updateDelta()}updateDelta(){if(this.uniforms.uDelta[0]=0,this.uniforms.uDelta[1]=0,this._tiltAxis===void 0)return;const t=this.uniforms.uEnd,e=this.uniforms.uStart,r=t.x-e.x,i=t.y-e.y,s=Math.sqrt(r*r+i*i),o=this._tiltAxis==="vertical";this.uniforms.uDelta[0]=o?-i/s:r/s,this.uniforms.uDelta[1]=o?r/s:i/s}};Hr(fp,"DEFAULT_OPTIONS",{blur:100,gradientBlur:600,start:{x:0,y:window.innerHeight/2},end:{x:600,y:window.innerHeight/2}});var dp=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,pp=Object.defineProperty,gp=(n,t,e)=>t in n?pp(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Ea=(n,t,e)=>(gp(n,typeof t!="symbol"?t+"":t,e),e);const xp=class ka extends N{constructor(t){t={...ka.DEFAULT_OPTIONS,...t};const e=B.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:mp,entryPoint:"mainFragment"}}),r=L.from({vertex:W,fragment:dp,name:"twist-filter"});super({gpuProgram:e,glProgram:r,resources:{twistUniforms:{uTwist:{value:[t.radius??0,t.angle??0],type:"vec2<f32>"},uOffset:{value:t.offset,type:"vec2<f32>"}}},...t}),Ea(this,"uniforms"),this.uniforms=this.resources.twistUniforms.uniforms}get radius(){return this.uniforms.uTwist[0]}set radius(t){this.uniforms.uTwist[0]=t}get angle(){return this.uniforms.uTwist[1]}set angle(t){this.uniforms.uTwist[1]=t}get offset(){return this.uniforms.uOffset}set offset(t){this.uniforms.uOffset=t}get offsetX(){return this.offset.x}set offsetX(t){this.offset.x=t}get offsetY(){return this.offset.y}set offsetY(t){this.offset.y=t}};Ea(xp,"DEFAULT_OPTIONS",{padding:20,radius:200,angle:4,offset:{x:0,y:0}});var vp=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
fn rand(co: vec2<f32>, seed: f32) -> f32
{
  ...
  return fract(sin(sn) * c + seed);
}`,_p=Object.defineProperty,bp=(n,t,e)=>t in n?_p(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Ba=(n,t,e)=>(bp(n,typeof t!="symbol"?t+"":t,e),e);const Sp=class Da extends N{constructor(t){t={...Da.DEFAULT_OPTIONS,...t};const e=t.maxKernelSize??32,r=B.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:yp.replace("${MAX_KERNEL_SIZE}",e.toFixed(1)),entryPoint:"mainFragment"}}),i=L.from({vertex:W,fragment:vp.replace("${MAX_KERNEL_SIZE}",e.toFixed(1)),name:"zoom-blur-filter"});super({gpuProgram:r,glProgram:i,resources:{zoomBlurUniforms:{uStrength:{value:t.strength,type:"f32"},uCenter:{value:t.center,type:"vec2<f32>"},uRadii:{value:new Float32Array(2),type:"vec2<f32>"}}}}),Ba(this,"uniforms"),this.uniforms=this.resources.zoomBlurUniforms.uniforms,Object.assign(this,t)}get strength(){return this.uniforms.uStrength}set strength(t){this.uniforms.uStrength=t}get center(){return this.uniforms.uCenter}set center(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uCenter=t}get centerX(){return this.uniforms.uCenter.x}set centerX(t){this.uniforms.uCenter.x=t}get centerY(){return this.uniforms.uCenter.y}set centerY(t){this.uniforms.uCenter.y=t}get innerRadius(){return this.uniforms.uRadii[0]}set innerRadius(t){this.uniforms.uRadii[0]=t}get radius(){return this.uniforms.uRadii[1]}set radius(t){this.uniforms.uRadii[1]=t<0||t===1/0?-1:t}};Ba(Sp,"DEFAULT_OPTIONS",{strength:.1,center:{x:0,y:0},innerRadius:0,radius:-1,maxKernelSize:32});class wp extends H{constructor(e){super();D(this,"startPos");D(this,"players",[]);D(this,"dragLimit");this.interactiveChildren=!1,this.dragLimit=e,this.x=e}onDragStart(){this.startPos=this.x}OnDragMove(e){let r=Math.round(e+this.startPos);this.x=Math.min(r,this.dragLimit),this.x=Math.max(this.x,-(this.width-G.width))}OnDragEnd(){this.startPos=this.x}velMove(e){let r=Math.round(this.x+e);this.x=Math.min(r,this.dragLimit),this.x=Math.max(this.x,-(this.width-G.width))}update(e){for(let r=0;r<this.players.length;r++)this.players[r].UpdateTextPos()}}const xr=window.Telegram.WebApp;class Cp extends H{constructor(e,r){var o,a,l;super();D(this,"sprite");D(this,"text");D(this,"_positionX");D(this,"_startPositionX");this.sprite=St.from(e),this.sprite.anchor.set(.5,1),this.sprite.y=G.height*.68,this.sprite.x=r*60,this.addChild(this.sprite);let i="Player "+r,s=xr==null?void 0:xr.initDataUnsafe;r==0&&(s==null?void 0:s.user)!==void 0&&((s==null?void 0:s.user.username)!==""||(s==null?void 0:s.user.username)!==void 0?i=(o=s==null?void 0:s.user)==null?void 0:o.username:i=((a=s==null?void 0:s.user)==null?void 0:a.first_name)+" "+((l=s==null?void 0:s.user)==null?void 0:l.last_name)),this.text=new Kt({text:i,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}}),this.text.anchor.set(.5),this._startPositionX=this.sprite.x,this._positionX=this.sprite.x}get startPositionX(){return this._startPositionX}setStartPositionX(){this._startPositionX=this.sprite.x}get positionX(){return this._positionX}set positionX(e){this._positionX=e,this.sprite.x=e}UpdateTextPos(){this.text.y=this.sprite.getGlobalPosition().y-this.sprite.height-10,this.text.x=this.sprite.getGlobalPosition().x}}const _s=50,Ap=12;class Tp extends H{constructor(){super();D(this,"gameScroll");D(this,"view");D(this,"ui");D(this,"buildings");D(this,"bg");D(this,"ground");D(this,"clouds");D(this,"mountain");D(this,"trees");D(this,"reflectionFilter");D(this,"isDrag",!1);D(this,"dragStartPos");D(this,"delta");D(this,"velX",0);this.gameScroll=new H;const e=new At;e.rect(0,0,G.width,G.height),e.fill("#1F66BA"),this.gameScroll.addChild(e),this.gameScroll.eventMode="static",this.addChild(this.gameScroll),this.createView(_s),this.addChild(this.view),this.buildings=new wp(_s),this.ui=new H,this.addChild(this.ui);for(let o=0;o<Ap;o++){let a=new Cp(o%2?"building01":"building02",o);this.buildings.players.push(a),this.buildings.addChild(a),this.ui.addChild(a.text)}this.view.addChild(this.buildings),this.updatePosition(this.buildings.x),this.reflectionFilter=new Ym({boundary:.71,alpha:[.5,.25],amplitude:[1,2]}),this.view.filters=[this.reflectionFilter];const r=o=>{this.isDrag=!0,this.dragStartPos=o.global.x,this.gameScroll.on("pointermove",i),this.buildings.onDragStart()},i=o=>{let a=this.delta;this.delta=o.data.global.x-this.dragStartPos,this.velX=this.delta-a,this.buildings.OnDragMove(this.delta),this.updatePosition(this.buildings.x)},s=()=>{this.isDrag=!1,this.buildings.OnDragEnd(),this.gameScroll.off("pointermove",i)};this.gameScroll.on("pointerdown",r),this.gameScroll.on("pointerup",s),this.gameScroll.on("pointerupoutside",s)}createView(e){this.view=new H,this.view.interactiveChildren=!1,this.bg=new Ue({texture:U.from("background01"),width:G.width*3,height:G.height}),this.bg.tileScale.y=.81,this.bg.anchor.set(0,.5),this.bg.x=-100,this.bg.y=G.height/2,this.bg.height=G.height,this.view.addChild(this.bg);let r=U.from("clouds01");this.clouds=new Ue({texture:r,width:4e3,height:r.height}),this.clouds.anchor.set(.5),this.clouds.x=Math.round(e*.15)+G.width/2,this.clouds.y=G.height*.5,this.view.addChild(this.clouds);let i=U.from("mountain01");this.mountain=new Ue({texture:i,width:4e3,height:i.height}),this.mountain.anchor.set(.5),this.mountain.x=Math.round(e*.35)+G.width/2,this.mountain.y=G.height*.5,this.view.addChild(this.mountain);let s=U.from("trees01");this.trees=new Ue({texture:s,width:4e3,height:s.height}),this.trees.anchor.set(.5),this.trees.x=Math.round(e*.55)+G.width/2,this.trees.y=G.height*.6,this.view.addChild(this.trees),this.ground=new Ue({texture:U.from("ground01"),width:4e3,height:24}),this.ground.anchor.set(.5,0),this.ground.x=e,this.ground.y=G.height*.68,this.view.addChild(this.ground)}updatePosition(e){this.ground.x=e,this.clouds.x=Math.round(e*.15)+G.width/2,this.mountain.x=Math.round(e*.35)+G.width/2,this.trees.x=Math.round(e*.55)+G.width/2}update(e){this.velX*=.95*e.deltaTime,Math.abs(this.velX)>0&&!this.isDrag&&(this.buildings.velMove(this.velX*e.deltaTime),this.updatePosition(this.buildings.x)),this.reflectionFilter.time+=e.deltaTime*.05,this.buildings.update(e)}}class Pp{constructor(){D(this,"score")}}class vr{static SaveData(t){localStorage.setItem("score",t.score.toString())}static LoadData(t){t.score=parseInt(localStorage.getItem("score"))||0}static ClearData(){localStorage.clear(),window.location.reload()}}class Mp extends H{constructor(){super();D(this,"background");D(this,"scoreText");D(this,"data");D(this,"assetBundles",["testBundle","background","buildings"]);this.data=new Pp,vr.LoadData(this.data)}sizeLog(){const e=Math.max(document.documentElement.clientWidth,window.innerWidth||0),r=Math.max(document.documentElement.clientHeight,window.innerHeight||0),i=new Kt({text:e+"x"+r,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});i.anchor.set(.5),i.x=G.width/2,i.y=G.width/2-30,this.addChild(i);const s=new Kt({text:G.enlargedWidth+"x"+G.enlargedHeight,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});s.anchor.set(.5),s.x=G.width/2,s.y=G.width/2-20,this.addChild(s);const o=new Kt({text:window.Telegram.WebApp.platform,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});o.anchor.set(.5),o.x=G.width/2,o.y=G.width/2-10,this.addChild(o)}constructorWithAssets(){this.background=new Tp,this.addChild(this.background),this.scoreText=new Kt({text:"Score: "+this.data.score,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}}),this.scoreText.anchor.set(.5),this.scoreText.x=G.width/2,this.scoreText.y=G.width/2+20,this.addChild(this.scoreText);let e=new At().roundRect(0,0,50,30,5).fill("black"),r=new Kt({text:`Increase 
score`,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});r.anchor.set(.5),r.x=e.width/2,r.y=e.height/2;const i=new xs;i.addChild(e),i.addChild(r),i.x=5,i.y=55,i.onPress.connect(()=>{this.data.score++,this.scoreText.text="Score: "+this.data.score,vr.SaveData(this.data)}),this.addChild(i),e=new At().roundRect(0,0,20,20,5).fill("black"),r=new Kt({text:"❌",style:{fontSize:15}}),r.anchor.set(.5),r.x=e.width/2,r.y=e.height/2;const s=new xs;s.addChild(e),s.addChild(r),s.x=G.width-25,s.y=55,s.onPress.connect(()=>{vr.ClearData()}),this.addChild(s)}update(e){this.background.update(e)}}const un=window.Telegram.WebApp;let La=420;var bs;if(((bs=un.initDataUnsafe)==null?void 0:bs.user)!==void 0){un.ready(),un.expand();const n=100;document.body.style.overflowY="hidden",document.body.style.marginTop=`${n}px`,document.body.style.height=window.innerHeight+n+"px",document.body.style.paddingBottom=`${n}px`,window.scrollTo(0,n),un.platform==="tdesktop"&&(La=400)}(async()=>(await G.init(200,La,1),await G.changeScene(new Mp)))();export{Z as $,fo as A,nt as B,H as C,ot as D,k as E,N as F,B as G,wt as H,Fi as I,St as J,Ql as K,uu as L,Y as M,rt as N,at as O,ct as P,Pu as Q,wn as R,au as S,Qe as T,ro as U,Oi as V,Ml as W,Xn as X,j as Y,Es as Z,z as _,Cr as a,vo as a0,ye as a1,th as a2,Io as a3,Bh as a4,Dh as a5,be as a6,ut as a7,Xo as a8,Lh as a9,Co as aa,le as ab,Oh as ac,ie as ad,Ct as ae,Ri as af,At as ag,rl as ah,To as ai,Tt as b,L as c,Qr as d,mt as e,ts as f,pc as g,vc as h,Kn as i,Lt as j,hn as k,Zr as l,yo as m,vi as n,uo as o,Xs as p,Pt as q,ml as r,U as s,nl as t,yc as u,mc as v,lt as w,It as x,Us as y,dt as z};
