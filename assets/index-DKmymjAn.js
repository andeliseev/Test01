...
`;let Ce=null,qn=class{constructor(){Ce||(Ce=URL.createObjectURL(new Blob([_c],{type:"application/javascript"}))),this.worker=new Worker(Ce)}};qn.revokeObjectURL=function(){Ce&&(URL.revokeObjectURL(Ce),Ce=null)};const bc=`(function () {
    'use strict';
...
`,id=`struct AdvancedBloomUniforms {
  uBloomScale: f32,
  uBrightness: f32,
};
...
`,rd=`struct ExtractBrightnessUniforms {
  uThreshold: f32,
};
...
`,sd=Object.defineProperty,od=(i,t,e)=>t in i?sd(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,pa=(i,t,e)=>(od(i,typeof t!="symbol"?t+"":t,e),e);const ma=class ga extends ${constructor(t){t={...ga.DEFAULT_OPTIONS,...t};const e=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:rd,entryPoint:"mainFragment"}}),n=G.from({vertex:H,fragment:nd,name:"extract-brightness-filter"});super({gpuProgram:e,glProgram:n,resources:{extractBrightnessUniforms:{uThreshold:{value:t.threshold,type:"f32"}}}}),pa(this,"uniforms"),this.uniforms=this.resources.extractBrightnessUniforms.uniforms}get threshold(){return this.uniforms.uThreshold}set threshold(t){this.uniforms.uThreshold=t}};pa(ma,"DEFAULT_OPTIONS",{threshold:.5});let ad=ma;var ld=Object.defineProperty,ud=(i,t,e)=>t in i?ld(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,ye=(i,t,e)=>(ud(i,typeof t!="symbol"?t+"":t,e),e);const hd=class xa extends ${constructor(t){t={...xa.DEFAULT_OPTIONS,...t};const e=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:id,entryPoint:"mainFragment"}}),n=G.from({vertex:H,fragment:ed,name:"advanced-bloom-filter"});super({gpuProgram:e,glProgram:n,resources:{advancedBloomUniforms:{uBloomScale:{value:t.bloomScale,type:"f32"},uBrightness:{value:t.brightness,type:"f32"}},uMapTexture:z.WHITE}}),ye(this,"uniforms"),ye(this,"bloomScale",1),ye(this,"brightness",1),ye(this,"_extractFilter"),ye(this,"_blurFilter"),this.uniforms=this.resources.advancedBloomUniforms.uniforms,this._extractFilter=new ad({threshold:t.threshold}),this._blurFilter=new da({strength:t.kernels??t.blur,quality:t.kernels?void 0:t.quality}),Object.assign(this,t)}apply(t,e,n,r){const s=xt.getSameSizeTexture(e);this._extractFilter.apply(t,e,s,!0);const o=xt.getSameSizeTexture(e);this._blurFilter.apply(t,s,o,!0),this.uniforms.uBloomScale=this.bloomScale,this.uniforms.uBrightness=this.brightness,this.resources.uMapTexture=o.source,t.applyFilter(this,e,n,r),xt.returnTexture(o),xt.returnTexture(s)}get threshold(){return this._extractFilter.threshold}set threshold(t){this._extractFilter.threshold=t}get kernels(){return this._blurFilter.kernels}set kernels(t){this._blurFilter.kernels=t}get blur(){return this._blurFilter.strength}set blur(t){this._blurFilter.strength=t}get quality(){return this._blurFilter.quality}set quality(t){this._blurFilter.quality=t}get pixelSize(){return this._blurFilter.pixelSize}set pixelSize(t){typeof t=="number"&&(t={x:t,y:t}),Array.isArray(t)&&(t={x:t[0],y:t[1]}),this._blurFilter.pixelSize=t}get pixelSizeX(){return this._blurFilter.pixelSizeX}set pixelSizeX(t){this._blurFilter.pixelSizeX=t}get pixelSizeY(){return this._blurFilter.pixelSizeY}set pixelSizeY(t){this._blurFilter.pixelSizeY=t}};ye(hd,"DEFAULT_OPTIONS",{threshold:.5,bloomScale:1,brightness:1,blur:8,quality:4,pixelSize:{x:1,y:1}});var cd=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
fn unmapCoord(coord: vec2<f32> ) -> vec2<f32>
{
    ...
    mappedCoord /= gfu.uInputSize.xy;
    return mappedCoord;
}`,dd=Object.defineProperty,pd=(i,t,e)=>t in i?dd(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,Kn=(i,t,e)=>(pd(i,typeof t!="symbol"?t+"":t,e),e);const md=class va extends ${constructor(...t){let e=t[0]??{};typeof e=="number"&&(R("6.0.0","AsciiFilter constructor params are now options object. See params: { size, color, replaceColor }"),e={size:e});const n=(e==null?void 0:e.color)&&e.replaceColor!==!1;e={...va.DEFAULT_OPTIONS,...e};const r=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:fd,entryPoint:"mainFragment"}}),s=G.from({vertex:H,fragment:cd,name:"ascii-filter"});super({gpuProgram:r,glProgram:s,resources:{asciiUniforms:{uSize:{value:e.size,type:"f32"},uColor:{value:new Float32Array(3),type:"vec3<f32>"},uReplaceColor:{value:Number(n),type:"f32"}}}}),Kn(this,"uniforms"),Kn(this,"_color"),this.uniforms=this.resources.asciiUniforms.uniforms,this._color=new j,this.color=e.color??16777215}get size(){return this.uniforms.uSize}set size(t){this.uniforms.uSize=t}get color(){return this._color.value}set color(t){this._color.setValue(t);const[e,n,r]=this._color.toArray();this.uniforms.uColor[0]=e,this.uniforms.uColor[1]=n,this.uniforms.uColor[2]=r}get replaceColor(){return this.uniforms.uReplaceColor>.5}set replaceColor(t){this.uniforms.uReplaceColor=t?1:0}};Kn(md,"DEFAULT_OPTIONS",{size:8,color:16777215,replaceColor:!1});var gd=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,Kd=`struct ColorOverlayUniforms {
    uColor: vec3<f32>,
    uAlpha: f32,
};
...
`,Zd=Object.defineProperty,Qd=(i,t,e)=>t in i?Zd(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,Zn=(i,t,e)=>(Qd(i,typeof t!="symbol"?t+"":t,e),e);const Jd=class Ca extends ${constructor(...t){let e=t[0]??{};(typeof e=="number"||Array.isArray(e)||e instanceof Float32Array)&&(R("6.0.0","ColorOverlayFilter constructor params are now options object. See params: { color, alpha }"),e={color:e},t[1]!==void 0&&(e.alpha=t[1])),e={...Ca.DEFAULT_OPTIONS,...e};const n=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:Kd,entryPoint:"mainFragment"}}),r=G.from({vertex:H,fragment:qd,name:"color-overlay-filter"});super({gpuProgram:n,glProgram:r,resources:{colorOverlayUniforms:{uColor:{value:new Float32Array(3),type:"vec3<f32>"},uAlpha:{value:e.alpha,type:"f32"}}}}),Zn(this,"uniforms"),Zn(this,"_color"),this.uniforms=this.resources.colorOverlayUniforms.uniforms,this._color=new j,this.color=e.color??0}get color(){return this._color.value}set color(t){this._color.setValue(t);const[e,n,r]=this._color.toArray();this.uniforms.uColor[0]=e,this.uniforms.uColor[1]=n,this.uniforms.uColor[2]=r}get alpha(){return this.uniforms.uAlpha}set alpha(t){this.uniforms.uAlpha=t}};Zn(Jd,"DEFAULT_OPTIONS",{color:0,alpha:1});var tp=`in vec2 vTextureCoord;
out vec4 finalColor;
...
`,ep=`struct ColorReplaceUniforms {
...
fn mainFragment(
    ...
    return finalColor;
}`,ap=Object.defineProperty,lp=(i,t,e)=>t in i?ap(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,Pa=(i,t,e)=>(lp(i,typeof t!="symbol"?t+"":t,e),e);const up=class Ta extends ${constructor(...t){let e=t[0]??{};Array.isArray(e)&&(R("6.0.0","ConvolutionFilter constructor params are now options object. See params: { matrix, width, height }"),e={matrix:e},t[1]!==void 0&&(e.width=t[1]),t[2]!==void 0&&(e.height=t[2])),e={...Ta.DEFAULT_OPTIONS,...e};const n=e.width??200,r=e.height??200,s=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:op,entryPoint:"mainFragment"}}),o=G.from({vertex:H,fragment:sp,name:"convolution-filter"});super({gpuProgram:s,glProgram:o,resources:{convolutionUniforms:{uMatrix:{value:e.matrix,type:"mat3x3<f32>"},uTexelSize:{value:{x:1/n,y:1/r},type:"vec2<f32>"}}}}),Pa(this,"uniforms"),this.uniforms=this.resources.convolutionUniforms.uniforms,this.width=n,this.height=r}get matrix(){return this.uniforms.uMatrix}set matrix(t){t.forEach((e,n)=>{this.uniforms.uMatrix[n]=e})}get width(){return 1/this.uniforms.uTexelSize.x}set width(t){this.uniforms.uTexelSize.x=1/t}get height(){return 1/this.uniforms.uTexelSize.y}set height(t){this.uniforms.uTexelSize.y=1/t}};Pa(up,"DEFAULT_OPTIONS",{matrix:new Float32Array(9),width:200,height:200});var hp=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,Lp=`// Taken from https://gist.github.com/munrocket/236ed5ba7e409b8bdf1ff6eca5dcdc39
...
`,tm=`struct MultiColorReplaceUniforms {
...
const DOUBLE_PI: f32 = 3.14159265358979323846264 * 2.;`,cm=Object.defineProperty,fm=(i,t,e)=>t in i?cm(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,le=(i,t,e)=>(fm(i,typeof t!="symbol"?t+"":t,e),e);const Sr=class oe extends ${constructor(...t){let e=t[0]??{};typeof e=="number"&&(R("6.0.0","OutlineFilter constructor params are now options object. See params: { thickness, color, quality, alpha, knockout }"),e={thickness:e},t[1]!==void 0&&(e.color=t[1]),t[2]!==void 0&&(e.quality=t[2]),t[3]!==void 0&&(e.alpha=t[3]),t[4]!==void 0&&(e.knockout=t[4])),e={...oe.DEFAULT_OPTIONS,...e};const n=e.quality??.1,r=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:hm,entryPoint:"mainFragment"}}),s=G.from({vertex:H,fragment:um.replace(/\$\{ANGLE_STEP\}/,oe.getAngleStep(n).toFixed(7)),name:"outline-filter"});super({gpuProgram:r,glProgram:s,resources:{outlineUniforms:{uThickness:{value:new Float32Array(2),type:"vec2<f32>"},uColor:{value:new Float32Array(3),type:"vec3<f32>"},uAlpha:{value:e.alpha,type:"f32"},uAngleStep:{value:0,type:"f32"},uKnockout:{value:e.knockout?1:0,type:"f32"}}}}),le(this,"uniforms"),le(this,"_thickness"),le(this,"_quality"),le(this,"_color"),this.uniforms=this.resources.outlineUniforms.uniforms,this.uniforms.uAngleStep=oe.getAngleStep(n),this._color=new j,this.color=e.color??0,Object.assign(this,e)}apply(t,e,n,r){this.uniforms.uThickness[0]=this.thickness/e.source.width,this.uniforms.uThickness[1]=this.thickness/e.source.height,t.applyFilter(this,e,n,r)}static getAngleStep(t){return parseFloat((Math.PI*2/Math.max(t*oe.MAX_SAMPLES,oe.MIN_SAMPLES)).toFixed(7))}get thickness(){return this._thickness}set thickness(t){this._thickness=this.padding=t}get color(){return this._color.value}set color(t){this._color.setValue(t);const[e,n,r]=this._color.toArray();this.uniforms.uColor[0]=e,this.uniforms.uColor[1]=n,this.uniforms.uColor[2]=r}get alpha(){return this.uniforms.uAlpha}set alpha(t){this.uniforms.uAlpha=t}get quality(){return this._quality}set quality(t){this._quality=t,this.uniforms.uAngleStep=oe.getAngleStep(t)}get knockout(){return this.uniforms.uKnockout===1}set knockout(t){this.uniforms.uKnockout=t?1:0}};le(Sr,"DEFAULT_OPTIONS",{thickness:1,color:0,alpha:1,quality:.1,knockout:!1});le(Sr,"MIN_SAMPLES",1);le(Sr,"MAX_SAMPLES",100);var dm=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,Am=Object.defineProperty,Pm=(i,t,e)=>t in i?Am(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,Na=(i,t,e)=>(Pm(i,typeof t!="symbol"?t+"":t,e),e);const Tm=class $a extends ${constructor(...t){let e=t[0]??{};(Array.isArray(e)||"x"in e&&"y"in e)&&(R("6.0.0","RGBSplitFilter constructor params are now options object. See params: { red, green, blue }"),e={red:e},t[1]!==void 0&&(e.green=t[1]),t[2]!==void 0&&(e.blue=t[2])),e={...$a.DEFAULT_OPTIONS,...e};const n=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:Cm,entryPoint:"mainFragment"}}),r=G.from({vertex:H,fragment:wm,name:"rgb-split-filter"});super({gpuProgram:n,glProgram:r,resources:{rgbSplitUniforms:{uRed:{value:e.red,type:"vec2<f32>"},uGreen:{value:e.green,type:"vec2<f32>"},uBlue:{value:e.blue,type:"vec2<f32>"}}}}),Na(this,"uniforms"),this.uniforms=this.resources.rgbSplitUniforms.uniforms,Object.assign(this,e)}get red(){return this.uniforms.uRed}set red(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uRed=t}get redX(){return this.red.x}set redX(t){this.red.x=t}get redY(){return this.red.y}set redY(t){this.red.y=t}get green(){return this.uniforms.uGreen}set green(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uGreen=t}get greenX(){return this.green.x}set greenX(t){this.green.x=t}get greenY(){return this.green.y}set greenY(t){this.green.y=t}get blue(){return this.uniforms.uBlue}set blue(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uBlue=t}get blueX(){return this.blue.x}set blueX(t){this.blue.x=t}get blueY(){return this.blue.y}set blueY(t){this.blue.y=t}};Na(Tm,"DEFAULT_OPTIONS",{red:{x:-10,y:0},green:{x:0,y:10},blue:{x:0,y:0}});var Mm=`
precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
}`,km=Object.defineProperty,Em=(i,t,e)=>t in i?km(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,Oi=(i,t,e)=>(Em(i,typeof t!="symbol"?t+"":t,e),e);const Bm=class Va extends ${constructor(...t){let e=t[0]??{};if(e instanceof z&&(R("6.0.0","SimpleLightmapFilter constructor params are now options object. See params: { lightMap, color, alpha }"),e={lightMap:e},t[1]!==void 0&&(e.color=t[1]),t[2]!==void 0&&(e.alpha=t[2])),e={...Va.DEFAULT_OPTIONS,...e},!e.lightMap)throw Error("No light map texture source was provided to SimpleLightmapFilter");const n=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:Rm,entryPoint:"mainFragment"}}),r=G.from({vertex:H,fragment:Um,name:"simple-lightmap-filter"});super({gpuProgram:n,glProgram:r,resources:{simpleLightmapUniforms:{uColor:{value:new Float32Array(3),type:"vec3<f32>"},uAlpha:{value:e.alpha,type:"f32"},uDimensions:{value:new Float32Array(2),type:"vec2<f32>"}},uMapTexture:e.lightMap.source,uMapSampler:e.lightMap.source.style}}),Oi(this,"uniforms"),Oi(this,"_color"),Oi(this,"_lightMap"),this.uniforms=this.resources.simpleLightmapUniforms.uniforms,this._color=new j,this.color=e.color??0,Object.assign(this,e)}apply(t,e,n,r){this.uniforms.uDimensions[0]=e.frame.width,this.uniforms.uDimensions[1]=e.frame.height,t.applyFilter(this,e,n,r)}get lightMap(){return this._lightMap}set lightMap(t){this._lightMap=t,this.resources.uMapTexture=t.source,this.resources.uMapSampler=t.source.style}get color(){return this._color.value}set color(t){this._color.setValue(t);const[e,n,r]=this._color.toArray();this.uniforms.uColor[0]=e,this.uniforms.uColor[1]=n,this.uniforms.uColor[2]=r}get alpha(){return this.uniforms.uAlpha}set alpha(t){this.uniforms.uAlpha=t}};Oi(Bm,"DEFAULT_OPTIONS",{lightMap:z.WHITE,color:0,alpha:1});var Dm=`in vec2 vTextureCoord;
out vec4 finalColor;
...
}`,Gm=Object.defineProperty,Nm=(i,t,e)=>t in i?Gm(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,rr=(i,t,e)=>(Nm(i,typeof t!="symbol"?t+"":t,e),e);const $m=class Ha extends ${constructor(t){t={...Ha.DEFAULT_OPTIONS,...t};const e=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:Lm,entryPoint:"mainFragment"}}),n=G.from({vertex:H,fragment:Dm,name:"tilt-shift-axis-filter"});super({gpuProgram:e,glProgram:n,resources:{tiltShiftUniforms:{uBlur:{value:new Float32Array([t.blur??100,t.gradientBlur??600]),type:"vec2<f32>"},uStart:{value:t.start,type:"vec2<f32>"},uEnd:{value:t.end,type:"vec2<f32>"},uDelta:{value:new Float32Array([30,30]),type:"vec2<f32>"},uTexSize:{value:new Float32Array([window.innerWidth,window.innerHeight]),type:"vec2<f32>"}}}}),rr(this,"uniforms"),rr(this,"_tiltAxis"),this.uniforms=this.resources.tiltShiftUniforms.uniforms,this._tiltAxis=t.axis,this.updateDelta()}updateDelta(){if(this.uniforms.uDelta[0]=0,this.uniforms.uDelta[1]=0,this._tiltAxis===void 0)return;const t=this.uniforms.uEnd,e=this.uniforms.uStart,n=t.x-e.x,r=t.y-e.y,s=Math.sqrt(n*n+r*r),o=this._tiltAxis==="vertical";this.uniforms.uDelta[0]=o?-r/s:n/s,this.uniforms.uDelta[1]=o?n/s:r/s}};rr($m,"DEFAULT_OPTIONS",{blur:100,gradientBlur:600,start:{x:0,y:window.innerHeight/2},end:{x:600,y:window.innerHeight/2}});var Wm=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,Hm=Object.defineProperty,Xm=(i,t,e)=>t in i?Hm(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,Xa=(i,t,e)=>(Xm(i,typeof t!="symbol"?t+"":t,e),e);const Ym=class Ya extends ${constructor(t){t={...Ya.DEFAULT_OPTIONS,...t};const e=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:Vm,entryPoint:"mainFragment"}}),n=G.from({vertex:H,fragment:Wm,name:"twist-filter"});super({gpuProgram:e,glProgram:n,resources:{twistUniforms:{uTwist:{value:[t.radius??0,t.angle??0],type:"vec2<f32>"},uOffset:{value:t.offset,type:"vec2<f32>"}}},...t}),Xa(this,"uniforms"),this.uniforms=this.resources.twistUniforms.uniforms}get radius(){return this.uniforms.uTwist[0]}set radius(t){this.uniforms.uTwist[0]=t}get angle(){return this.uniforms.uTwist[1]}set angle(t){this.uniforms.uTwist[1]=t}get offset(){return this.uniforms.uOffset}set offset(t){this.uniforms.uOffset=t}get offsetX(){return this.offset.x}set offsetX(t){this.offset.x=t}get offsetY(){return this.offset.y}set offsetY(t){this.offset.y=t}};Xa(Ym,"DEFAULT_OPTIONS",{padding:20,radius:200,angle:4,offset:{x:0,y:0}});var jm=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
fn rand(co: vec2<f32>, seed: f32) -> f32
{
  ...
  return fract(sin(sn) * c + seed);
}`,Km=Object.defineProperty,Zm=(i,t,e)=>t in i?Km(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,ja=(i,t,e)=>(Zm(i,typeof t!="symbol"?t+"":t,e),e);const Qm=class qa extends ${constructor(t){t={...qa.DEFAULT_OPTIONS,...t};const e=t.maxKernelSize??32,n=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:qm.replace("${MAX_KERNEL_SIZE}",e.toFixed(1)),entryPoint:"mainFragment"}}),r=G.from({vertex:H,fragment:jm.replace("${MAX_KERNEL_SIZE}",e.toFixed(1)),name:"zoom-blur-filter"});super({gpuProgram:n,glProgram:r,resources:{zoomBlurUniforms:{uStrength:{value:t.strength,type:"f32"},uCenter:{value:t.center,type:"vec2<f32>"},uRadii:{value:new Float32Array(2),type:"vec2<f32>"}}}}),ja(this,"uniforms"),this.uniforms=this.resources.zoomBlurUniforms.uniforms,Object.assign(this,t)}get strength(){return this.uniforms.uStrength}set strength(t){this.uniforms.uStrength=t}get center(){return this.uniforms.uCenter}set center(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uCenter=t}get centerX(){return this.uniforms.uCenter.x}set centerX(t){this.uniforms.uCenter.x=t}get centerY(){return this.uniforms.uCenter.y}set centerY(t){this.uniforms.uCenter.y=t}get innerRadius(){return this.uniforms.uRadii[0]}set innerRadius(t){this.uniforms.uRadii[0]=t}get radius(){return this.uniforms.uRadii[1]}set radius(t){this.uniforms.uRadii[1]=t<0||t===1/0?-1:t}};ja(Qm,"DEFAULT_OPTIONS",{strength:.1,center:{x:0,y:0},innerRadius:0,radius:-1,maxKernelSize:32});const In=window.Telegram.WebApp;class Jm extends N{constructor(e,n,r){var l,h,u;super();T(this,"sprite");T(this,"nameText");T(this,"levelText");T(this,"data");this.data=r;const s=Et.get("buildings").data.animations;this.sprite=ti.fromImages(s[e]),this.sprite.anchor.set(.5,1),this.sprite.y=Math.round(A.height*.684),this.sprite.x=n*80,this.addChild(this.sprite);let o="Friend "+n,a=In==null?void 0:In.initDataUnsafe;n==0&&(a==null?void 0:a.user)!==void 0&&((a==null?void 0:a.user.username)!==""||(a==null?void 0:a.user.username)!==void 0?o=(l=a==null?void 0:a.user)==null?void 0:l.username:o=((h=a==null?void 0:a.user)==null?void 0:h.first_name)+" "+((u=a==null?void 0:a.user)==null?void 0:u.last_name)),this.nameText=new mt({text:o,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}}),this.nameText.anchor.set(.5),this.levelText=new mt({text:"Lvl. "+r.level,style:{fontFamily:"Arial",fontSize:6,fontWeight:"bold",fill:"gray",align:"center",stroke:{color:"black",width:2,join:"round"}}}),this.levelText.anchor.set(.5),this.setCurrentLevel()}setCurrentLevel(){this.sprite.currentFrame=Math.min(this.data.level,this.sprite.totalFrames-1),this.nameText.y=this.sprite.y-this.sprite.height-10,this.nameText.x=this.sprite.x,this.levelText.text="Lvl. "+this.data.level,this.levelText.x=this.sprite.x,this.levelText.y=this.sprite.y+6}update(e){}}class tg extends N{constructor(e){super();T(this,"players",[]);this.interactiveChildren=!1}update(e){for(let n=0;n<this.players.length;n++)this.players[n].update(e)}updatePosition(e){this.x=Math.round(e)}addBuilding(e){let n=new Jm("building01",this.players.length,e);return this.players.push(n),this.addChild(n),n}}class eg extends N{constructor(e){super();T(this,"bg");T(this,"ground");T(this,"clouds");T(this,"mountain");T(this,"trees");this.interactiveChildren=!1,this.bg=new $e({texture:z.from("background01"),width:A.width*3,height:A.height}),this.bg.tileScale.y=.81,this.bg.anchor.set(0,.5),this.bg.y=A.height/2,this.bg.height=A.height,this.addChild(this.bg);let n=z.from("clouds01");this.clouds=new $e({texture:n,width:4e3,height:n.height}),this.clouds.anchor.set(.5),this.clouds.x=Math.round(e*.15+A.width/2),this.clouds.y=Math.round(A.height*.5),this.addChild(this.clouds);let r=z.from("mountain01");this.mountain=new $e({texture:r,width:4e3,height:r.height}),this.mountain.anchor.set(.5),this.mountain.x=Math.round(e*.35+A.width/2),this.mountain.y=Math.round(A.height*.5),this.addChild(this.mountain);let s=z.from("trees01");this.trees=new $e({texture:s,width:4e3,height:s.height}),this.trees.anchor.set(.5,0),this.trees.y=Math.round(A.height*.5),this.addChild(this.trees),this.ground=new $e({texture:z.from("ground01"),width:4e3,height:24}),this.ground.anchor.set(.5,0),this.ground.x=e,this.ground.y=Math.round(A.height*.68),this.addChild(this.ground)}updatePosition(e){this.ground.x=Math.round(e),this.clouds.x=Math.round(e*.15+A.width/2),this.mountain.x=Math.round(e*.35+A.width/2),this.trees.x=Math.round(e*.55+A.width/2)}update(e){}}var _i=[{divider:1e21,suffix:"Z"},{divider:1e18,suffix:"E"},{divider:1e15,suffix:"P"},{divider:1e12,suffix:"T"},{divider:1e9,suffix:"G"},{divider:1e6,suffix:"M"},{divider:1e3,suffix:"k"}];const Ka=(i,t,e)=>i*(1-e)+t*e;function ig(i){for(var t=0;t<_i.length;t++)if(i>=_i[t].divider)return(i/_i[t].divider).toFixed(3).toString()+_i[t].suffix;return i.toString()}function ng(i,t){const e=Math.ceil(i),n=Math.floor(t);return Math.floor(Math.random()*(n-e)+e)}class rg{constructor(){T(this,"friends");this.friends=[]}get ourMoney(){return this.friends[0].money}get ourLevel(){return this.friends[0].level}increaseMoney(t,e){this.friends[t].money+=e}increaseLevel(t){this.friends[t].level++}}class Za{constructor(t,e){T(this,"level");T(this,"money");t!=null?this.level=t:this.level=0,e!=null?this.money=e:this.money=0}}const ae=[1,5,15,30,60,120,240,500,1100,2250,5e3],Os=50;class sg extends N{constructor(e){super();T(this,"scroller");T(this,"view");T(this,"ingameUI");T(this,"background");T(this,"buildings");T(this,"reflectionFilter");T(this,"_isDrag",!1);T(this,"_delta");T(this,"_prevDragPos");T(this,"_currentDragPosition");T(this,"_viewPos");T(this,"data");this.data=e,this.scroller=new N;const n=new dt().rect(0,0,A.width,A.height).fill("#1F66BA");this.scroller.addChild(n),this.scroller.eventMode="static",this.addChild(this.scroller),this.view=new N,this.addChild(this.view),this.background=new eg(Os),this.view.addChild(this.background),this.ingameUI=new N,this.buildings=new tg(Os),this.ingameUI.x=this.buildings.x,this.addChild(this.ingameUI);for(let a=0;a<e.friends.length;a++)this.addPlayer(e.friends[a]);this.view.addChild(this.buildings),this.reflectionFilter=new Sm({boundary:.71,alpha:[.5,.25],amplitude:[1,2]}),this.view.filters=[this.reflectionFilter];const r=a=>{this._isDrag=!0,this._currentDragPosition=a.global.x,this._prevDragPos=this._currentDragPosition,this.scroller.on("pointermove",s)},s=a=>{this._currentDragPosition=a.global.x},o=()=>{this._isDrag=!1,this.scroller.off("pointermove",s)};this.scroller.on("pointerdown",r),this.scroller.on("pointerup",o),this.scroller.on("pointerupoutside",o),this._viewPos=A.width/2,this.updatePosition()}get currentViewPos(){return this.buildings.x}addPlayer(e){const n=this.buildings.addBuilding(e);this.ingameUI.addChild(n.nameText),this.ingameUI.addChild(n.levelText)}increasePlayerLevel(e){this.buildings.players[e].setCurrentLevel()}updatePosition(){this.buildings.updatePosition(this._viewPos),this.background.updatePosition(this._viewPos),this.ingameUI.x=this.buildings.x}update(e){if(this._isDrag?(this._delta=this._currentDragPosition-this._prevDragPos,this._prevDragPos=this._currentDragPosition):this._delta=Ka(this._delta,0,e.deltaTime*.04),Math.abs(this._delta)>.1){let n=this.buildings.players.length;this._viewPos=Math.min(this._viewPos+this._delta,A.width/2),this._viewPos=Math.max(this._viewPos,-(this.buildings.width-A.width/2-this.buildings.players[n-1].width)),this.updatePosition()}this.reflectionFilter.time+=e.deltaTime*.05,this.background.update(e)}updateByTimer(){const e=Et.get("buildings").data.animations;for(let n=0;n<this.data.friends.length;n++)if(this.data.increaseMoney(n,ae[this.data.friends[n].level]),this.data.friends[n].level>0){const r=ti.fromImages(e.coin);r.anchor.set(.5);const s=this.buildings.players[n];r.x=s.nameText.x,r.y=s.nameText.y-16,r.animationSpeed=1/5,r.loop=!1,r.play(),r.onFrameChange=()=>{r.y=s.nameText.y-16-r.currentFrame},r.onComplete=()=>{r.destroy()},this.ingameUI.addChild(r)}}}class Ke{static SaveData(t){localStorage.setItem("friends",JSON.stringify(t.friends))}static LoadData(t){const e=JSON.parse(localStorage.getItem("friends"));e!=null?t.friends=e:t.friends.push(new Za)}static ClearData(){localStorage.clear(),window.location.reload()}}class og extends N{constructor(){super();T(this,"scroller");T(this,"scrollBox");T(this,"backButton");const e=new dt().rect(0,0,A.width,A.height).fill("gray"),n=new dt().rect(0,A.bottomPos-54,A.width,54).fill("3E3E3E");this.addChild(e),this.addChild(n);const r=6,s=A.rightPos-A.leftPos-r*2-2,o=40,a=this.createButton(` Agriculture 
🚜🌽👨‍🌾`,s,o,"#33C481"),l=this.createButton(` Telecommunication 
🌍📡🌐`,s,o,"#3191F7"),h=this.createButton(` Chemicals 
🧪⚗️👩‍🔬🔬`,s,o,"#22E528"),u=this.createButton(` Energy 
⚡🔌💡🔋`,s,o,"#F0E31A"),c=this.createButton(` Retail 
🛒🛍️🎁📦`,s,o,"#81B8A5"),f=this.createButton(` Health Care 
🧑‍⚕️🚑🩺🩼`,s,o,"#B65452"),d=this.createButton(` Public Transport 
🚌🚋🚕🚈`,s,o,"#9296A0");this.scrollBox=new $f({elementsMargin:r,width:A.rightPos-r*2,height:A.bottomPos-A.topPos-60-r,radius:5,disableEasing:!1,globalScroll:!0,shiftScroll:!1}),this.scrollBox.x=A.leftPos+r,this.scrollBox.y=A.topPos+r,this.addChild(this.scrollBox),this.scrollBox.addItem(d,c,f,a,l,h,u);const p=new dt().roundRect(A.rightPos-6,0,4,this.scrollBox.height,1).fill("black");p.alpha=.5,p.y=this.scrollBox.y,this.addChild(p),this.scroller=new dt().roundRect(A.rightPos-6,0,4,40,1).fill("00DCFF"),this.addChild(this.scroller),this.backButton=this.createButton(" Назад ",s,o,"ED4C4C"),this.backButton.x=A.leftPos+r,this.backButton.y=A.bottomPos-this.backButton.height-r,this.backButton.onPress.connect(()=>{this.visible=!1}),this.addChild(this.backButton)}createButton(e,n,r,s){const o=new mt({text:e,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",dropShadow:{alpha:.5,distance:1,angle:1,blur:2},stroke:{color:"#4a1850",width:2,join:"round"}}}),a=new ue(z.from("button.png"));a.tint=s,a.width=n,a.height=r,o.anchor.set(.5),o.x=a.width/2,o.y=a.height/2-2;const l=new Ai;return l.addChild(a),l.addChild(o),l}update(e){console.log(this.scrollBox.height),this.scroller.y=Ka(this.scrollBox.y,this.scrollBox.y+this.scrollBox.height-this.scroller.height,Math.min(Math.max(-this.scrollBox.scrollY/(this.scrollBox.items.length*40-this.scrollBox.height+(this.scrollBox.items.length-1)*6),0),1))}}class ag extends N{constructor(e,n){super();T(this,"moneyText");T(this,"profitText");T(this,"friendsText");T(this,"businnessScreen");T(this,"game");T(this,"data");T(this,"clearSaveButton");T(this,"upgradeButton");T(this,"inviteFriendButton");this.game=e,this.data=n,this.moneyText=new mt({text:"Money: $"+n.ourMoney,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}}),this.moneyText.anchor.set(0,.5),this.addChild(this.moneyText),this.profitText=new mt({text:"Profit: $"+ae[n.ourLevel]+"/c",style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}}),this.profitText.anchor.set(1,.5),this.addChild(this.profitText),this.friendsText=new mt({text:"Friends: "+n.friends.length,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}}),this.friendsText.anchor.set(0,.5),this.friendsText.visible=!1,this.addChild(this.friendsText);let r=new ue(z.from("button.png"));r.tint="gray",r.width=50,r.height=30;let s=new mt({text:`Invite
friends`,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});s.anchor.set(.5),s.x=r.width/2,s.y=r.height/2-2,this.inviteFriendButton=new Ai,this.inviteFriendButton.addChild(r),this.inviteFriendButton.addChild(s),this.inviteFriendButton.onPress.connect(()=>{const o=new Za(ng(1,5));n.friends.push(o),Ke.SaveData(n),open("https://t.me/share/url?url=https://t.me/andeliseevTest01_bot&text=Играй! Строй! ЗАРАБАТЫВАЙ!","_blank"),this.friendsText.text="Friends: "+n.friends.length,e.gameView.addPlayer(o)}),this.inviteFriendButton.visible=n.ourLevel>2,this.addChild(this.inviteFriendButton),r=new ue(z.from("button.png")),r.tint="orange",r.width=50,r.height=30,s=new mt({text:"Upgrade",style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}}),s.anchor.set(.5),s.x=r.width/2,s.y=r.height/2-2,this.upgradeButton=new Ai,this.upgradeButton.addChild(r),this.upgradeButton.addChild(s),this.upgradeButton.x=A.rightPos-this.upgradeButton.width-5,this.upgradeButton.y=A.topPos+20,this.upgradeButton.enabled=n.ourLevel<ae.length-1,this.upgradeButton.alpha=n.ourLevel<ae.length-1?1:.4,this.upgradeButton.onPress.connect(()=>{n.ourLevel<ae.length&&(n.increaseLevel(0),Ke.SaveData(n),this.profitText.text="Profit: $"+ae[n.ourLevel]+"/c",e.gameView.increasePlayerLevel(0),this.inviteFriendButton.visible=n.ourLevel>2,n.ourLevel===ae.length-1&&(this.upgradeButton.enabled=!1,this.upgradeButton.alpha=.4))}),this.addChild(this.upgradeButton),r=new ue(z.from("button.png")),r.tint="#404040",r.width=20,r.height=20,s=new mt({text:"❌",style:{fontSize:13}}),s.anchor.set(.5),s.x=r.width/2,s.y=r.height/2-1,this.clearSaveButton=new Ai,this.clearSaveButton.addChild(r),this.clearSaveButton.addChild(s),this.clearSaveButton.onPress.connect(()=>{Ke.ClearData()}),this.addChild(this.clearSaveButton),this.businnessScreen=new og,this.addChild(this.businnessScreen),window.addEventListener("resize",()=>{this.resize()}),this.resize()}update(e){this.businnessScreen.visible&&this.businnessScreen.update(e)}updateByTimer(){this.moneyText.text="Money: $"+ig(this.data.ourMoney)}resize(){this.moneyText.x=A.leftPos+5,this.moneyText.y=A.topPos+10,this.friendsText.x=A.leftPos+5,this.friendsText.y=A.topPos+25,this.profitText.x=A.rightPos-5,this.profitText.y=A.topPos+10,this.inviteFriendButton.x=A.rightPos-this.inviteFriendButton.width-5,this.inviteFriendButton.y=A.bottomPos-this.inviteFriendButton.height-5,this.upgradeButton.x=A.width/2-this.upgradeButton.width/2,this.upgradeButton.y=A.bottomPos-this.inviteFriendButton.height-5,this.clearSaveButton.x=A.rightPos-this.clearSaveButton.width-5,this.clearSaveButton.y=A.topPos+20}}class lg extends N{constructor(){super();T(this,"gameView");T(this,"mainUI");T(this,"data");T(this,"timer");T(this,"assetBundles",["testBundle","background","buildings"]);this.data=new rg,Ke.LoadData(this.data)}sizeLog(){const e=Math.max(document.documentElement.clientWidth,window.innerWidth||0),n=Math.max(document.documentElement.clientHeight,window.innerHeight||0),r=new mt({text:e+"x"+n,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});r.anchor.set(.5),r.x=A.width/2,r.y=A.width/2-30,this.addChild(r);const s=new mt({text:A.enlargedWidth+"x"+A.enlargedHeight,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});s.anchor.set(.5),s.x=A.width/2,s.y=A.width/2-20,this.addChild(s);const o=new mt({text:window.Telegram.WebApp.platform,style:{fontFamily:"Arial",fontSize:9,fontWeight:"bold",fill:"white",align:"center",stroke:{color:"#4a1850",width:2,join:"round"}}});o.anchor.set(.5),o.x=A.width/2,o.y=A.width/2-10,this.addChild(o)}constructorWithAssets(){this.gameView=new sg(this.data),this.addChild(this.gameView),this.mainUI=new ag(this,this.data),this.addChild(this.mainUI)}update(e){this.gameView.update(e),this.mainUI.update(e),this.timer>0?this.timer-=e.deltaTime:this.data.ourLevel>0&&(this.timer=60,this.gameView.updateByTimer(),this.mainUI.updateByTimer(),Ke.SaveData(this.data))}}let Qa=420,wr=100;Xt.isDesktop&&(Qa=400,wr=12);window.addEventListener("load",()=>{Xt.FixScroll(wr)});(async()=>(await A.init(200,Qa,1,wr),await A.changeScene(new lg)))();export{Q as $,Co as A,nt as B,N as C,lt as D,D as E,$ as F,L as G,Tt as H,Nr as I,Pt as J,cu as K,Su as L,Y as M,st as N,rt as O,ut as P,Gu as Q,Bi as R,_u as S,kt as T,mo as U,Vr as V,Nl as W,on as X,j as Y,Xs as Z,R as _,ki as a,Fo as a0,Me as a1,dc as a2,$o as a3,Kc as a4,Zc as a5,Ie as a6,ct as a7,ia as a8,Qc as a9,ko as aa,ge as ab,Hc as ac,fe as ad,Mt as ae,Xr as af,dt as ag,gl as ah,Bo as ai,Ft as b,G as c,ur as d,vt as e,fs as f,Mh as g,zh as h,Si as i,Yt as j,wi as k,lr as l,Io as m,Ir as n,bo as o,io as p,It as q,Tl as r,z as s,ml as t,Oh as u,Th as v,ht as w,Rt as x,Vs as y,xt as z};
