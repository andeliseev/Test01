...
`;let ve=null,Wr=class{constructor(){ve||(ve=URL.createObjectURL(new Blob([hh],{type:"application/javascript"}))),this.worker=new Worker(ve)}};Wr.revokeObjectURL=function(){ve&&(URL.revokeObjectURL(ve),ve=null)};const fh=`(function () {
    'use strict';
