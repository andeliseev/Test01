...
`;let ve=null,$r=class{constructor(){ve||(ve=URL.createObjectURL(new Blob([hh],{type:"application/javascript"}))),this.worker=new Worker(ve)}};$r.revokeObjectURL=function(){ve&&(URL.revokeObjectURL(ve),ve=null)};const fh=`(function () {
    'use strict';
...
`,_p=Object.defineProperty,bp=(n,t,e)=>t in n?_p(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e,Da=(n,t,e)=>(bp(n,typeof t!="symbol"?t+"":t,e),e);const Sp=class La extends N{constructor(t){t={...La.DEFAULT_OPTIONS,...t};const e=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:yp,entryPoint:"mainFragment"}}),r=G.from({vertex:V,fragment:vp,name:"twist-filter"});super({gpuProgram:e,glProgram:r,resources:{twistUniforms:{uTwist:{value:[t.radius??0,t.angle??0],type:"vec2<f32>"},uOffset:{value:t.offset,type:"vec2<f32>"}}},...t}),Da(this,"uniforms"),this.uniforms=this.resources.twistUniforms.uniforms}get radius(){return this.uniforms.uTwist[0]}set radius(t){this.uniforms.uTwist[0]=t}get angle(){return this.uniforms.uTwist[1]}set angle(t){this.uniforms.uTwist[1]=t}get offset(){return this.uniforms.uOffset}set offset(t){this.uniforms.uOffset=t}get offsetX(){return this.offset.x}set offsetX(t){this.offset.x=t}get offsetY(){return this.offset.y}set offsetY(t){this.offset.y=t}};Da(Sp,"DEFAULT_OPTIONS",{padding:20,radius:200,angle:4,offset:{x:0,y:0}});var wp=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
