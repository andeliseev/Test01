...
`,up=Object.defineProperty,hp=(i,t,e)=>t in i?up(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,sr=(i,t,e)=>(hp(i,typeof t!="symbol"?t+"":t,e),e);const cp=class Ua extends ${constructor(...t){let e=t[0]??{};(typeof e=="number"||Array.isArray(e)||e instanceof Float32Array)&&(U("6.0.0","ColorOverlayFilter constructor params are now options object. See params: { color, alpha }"),e={color:e},t[1]!==void 0&&(e.alpha=t[1])),e={...Ua.DEFAULT_OPTIONS,...e};const n=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:lp,entryPoint:"mainFragment"}}),r=N.from({vertex:H,fragment:ap,name:"color-overlay-filter"});super({gpuProgram:n,glProgram:r,resources:{colorOverlayUniforms:{uColor:{value:new Float32Array(3),type:"vec3<f32>"},uAlpha:{value:e.alpha,type:"f32"}}}}),sr(this,"uniforms"),sr(this,"_color"),this.uniforms=this.resources.colorOverlayUniforms.uniforms,this._color=new j,this.color=e.color??0}get color(){return this._color.value}set color(t){this._color.setValue(t);const[e,n,r]=this._color.toArray();this.uniforms.uColor[0]=e,this.uniforms.uColor[1]=n,this.uniforms.uColor[2]=r}get alpha(){return this.uniforms.uAlpha}set alpha(t){this.uniforms.uAlpha=t}};sr(cp,"DEFAULT_OPTIONS",{color:0,alpha:1});var fp=`in vec2 vTextureCoord;
out vec4 finalColor;
...
fn mainFragment(
    ...
    return finalColor;
}`,yp=Object.defineProperty,_p=(i,t,e)=>t in i?yp(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,Ea=(i,t,e)=>(_p(i,typeof t!="symbol"?t+"":t,e),e);const bp=class Ra extends ${constructor(...t){let e=t[0]??{};Array.isArray(e)&&(U("6.0.0","ConvolutionFilter constructor params are now options object. See params: { matrix, width, height }"),e={matrix:e},t[1]!==void 0&&(e.width=t[1]),t[2]!==void 0&&(e.height=t[2])),e={...Ra.DEFAULT_OPTIONS,...e};const n=e.width??200,r=e.height??200,s=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:vp,entryPoint:"mainFragment"}}),o=N.from({vertex:H,fragment:xp,name:"convolution-filter"});super({gpuProgram:s,glProgram:o,resources:{convolutionUniforms:{uMatrix:{value:e.matrix,type:"mat3x3<f32>"},uTexelSize:{value:{x:1/n,y:1/r},type:"vec2<f32>"}}}}),Ea(this,"uniforms"),this.uniforms=this.resources.convolutionUniforms.uniforms,this.width=n,this.height=r}get matrix(){return this.uniforms.uMatrix}set matrix(t){t.forEach((e,n)=>{this.uniforms.uMatrix[n]=e})}get width(){return 1/this.uniforms.uTexelSize.x}set width(t){this.uniforms.uTexelSize.x=1/t}get height(){return 1/this.uniforms.uTexelSize.y}set height(t){this.uniforms.uTexelSize.y=1/t}};Ea(bp,"DEFAULT_OPTIONS",{matrix:new Float32Array(9),width:200,height:200});var Sp=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,Rm=Object.defineProperty,Dm=(i,t,e)=>t in i?Rm(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,Za=(i,t,e)=>(Dm(i,typeof t!="symbol"?t+"":t,e),e);const Lm=class Qa extends ${constructor(...t){let e=t[0]??{};(Array.isArray(e)||"x"in e&&"y"in e)&&(U("6.0.0","RGBSplitFilter constructor params are now options object. See params: { red, green, blue }"),e={red:e},t[1]!==void 0&&(e.green=t[1]),t[2]!==void 0&&(e.blue=t[2])),e={...Qa.DEFAULT_OPTIONS,...e};const n=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:Em,entryPoint:"mainFragment"}}),r=N.from({vertex:H,fragment:km,name:"rgb-split-filter"});super({gpuProgram:n,glProgram:r,resources:{rgbSplitUniforms:{uRed:{value:e.red,type:"vec2<f32>"},uGreen:{value:e.green,type:"vec2<f32>"},uBlue:{value:e.blue,type:"vec2<f32>"}}}}),Za(this,"uniforms"),this.uniforms=this.resources.rgbSplitUniforms.uniforms,Object.assign(this,e)}get red(){return this.uniforms.uRed}set red(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uRed=t}get redX(){return this.red.x}set redX(t){this.red.x=t}get redY(){return this.red.y}set redY(t){this.red.y=t}get green(){return this.uniforms.uGreen}set green(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uGreen=t}get greenX(){return this.green.x}set greenX(t){this.green.x=t}get greenY(){return this.green.y}set greenY(t){this.green.y=t}get blue(){return this.uniforms.uBlue}set blue(t){Array.isArray(t)&&(t={x:t[0],y:t[1]}),this.uniforms.uBlue=t}get blueX(){return this.blue.x}set blueX(t){this.blue.x=t}get blueY(){return this.blue.y}set blueY(t){this.blue.y=t}};Za(Lm,"DEFAULT_OPTIONS",{red:{x:-10,y:0},green:{x:0,y:10},blue:{x:0,y:0}});var Gm=`
precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
`,ng=Object.defineProperty,rg=(i,t,e)=>t in i?ng(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,il=(i,t,e)=>(rg(i,typeof t!="symbol"?t+"":t,e),e);const sg=class nl extends ${constructor(t){t={...nl.DEFAULT_OPTIONS,...t};const e=L.from({vertex:{source:X,entryPoint:"mainVertex"},fragment:{source:ig,entryPoint:"mainFragment"}}),n=N.from({vertex:H,fragment:eg,name:"twist-filter"});super({gpuProgram:e,glProgram:n,resources:{twistUniforms:{uTwist:{value:[t.radius??0,t.angle??0],type:"vec2<f32>"},uOffset:{value:t.offset,type:"vec2<f32>"}}},...t}),il(this,"uniforms"),this.uniforms=this.resources.twistUniforms.uniforms}get radius(){return this.uniforms.uTwist[0]}set radius(t){this.uniforms.uTwist[0]=t}get angle(){return this.uniforms.uTwist[1]}set angle(t){this.uniforms.uTwist[1]=t}get offset(){return this.uniforms.uOffset}set offset(t){this.uniforms.uOffset=t}get offsetX(){return this.offset.x}set offsetX(t){this.offset.x=t}get offsetY(){return this.offset.y}set offsetY(t){this.offset.y=t}};il(sg,"DEFAULT_OPTIONS",{padding:20,radius:200,angle:4,offset:{x:0,y:0}});var og=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
